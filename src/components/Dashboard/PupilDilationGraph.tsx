...
interface PupilDilationGraphProps {
  graphType: "individual" | "group";
}

const PupilDilationGraph = ({ graphType }: PupilDilationGraphProps) => {
  const originalData =
      ...
      <div className="h-64 px-4 mb-12">
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <YAxis
              domain={[50, 350]}
              label={{ value: "Dilation", angle: -90, position: "insideLeft" }}
            />
            {graphType === "individual" && (
              <Tooltip
